...
//						guild.addRoleToMember(event.getMember(), guild.getRoleById(rollenid)).queue();
						event.getGuild().addRoleToMember(event.getMember(), event.getGuild().getRoleById(rollenid)).queue();
					}
...
//						guild.removeRoleFromMember(event.getMember(), guild.getRoleById(rollenid)).queue();
						event.getGuild().removeRoleFromMember(event.getMember(), event.getGuild().getRoleById(rollenid)).queue();
					}
				} catch (SQLException e) {
					e.printStackTrace();
				}
